...
```
Using Gower dist, we began clustering rating, genre, and month. The most interesting finding in the Full Hierarchial Clustering dendogram is the leftmost red cluster, which remains its own cluster far longer than the green and blue cluster. 



# <span style="color: mediumslateblue;">Discussion and Conclusion</span>

**Multiple Regression:** One of the main issues we encountered with each multiple regression model was that they continually had high-leverage points. Upon closer examination of the films that constituted these points we gained some insight into the predictive capabilities of this data set. The movies in our data with high leverage included: Pulp Fiction, The Dark Knight, The Shawshank Redemption, The Matrix, Forrest Gump and Inception. Even if you are not an avid movie enthusiast, you probably recognize most of the films in this list. What our model struggles to predict are these super-hit classic films that rock our cultural world. However, this model may give you an idea of IMDB score based on the budget, number of votes and runtime of you average, run-of-the-mill film. This suggests that there are other layers to the art of film-making not quantified in this data. These could include movie metrics like script quality, actor performance, cinematography, or novelty. Our findings suggest these unrepresented qualities are important to public reception, yet they may be difficult to measure. Perhaps this is why they call it movie magic!
