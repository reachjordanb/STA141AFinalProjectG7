...
Looking at the Full clustering table, we that the mean year and votes increase between cluster 1 to cluster 3, whereas in the Reduced Variable clustering table, we do not see this same pattern between those variables. 
