...
For the Reduced Variables Hierarchial Clustering, we removed the variables that were found the be not significant, leaving the reduced model with rating, genre, year, score, adn budget. The most interesting finding in the Full Hierarchial Clustering was the red cluster, which had a different clade than the green and blue. The Reduced Variable Hierarchial Clustering ended up with 6 clades, while the Full Clustering had 3.
