...
We removed variables as an exploration to give us a clustering we believed would be intuitive to compare to the full model. The Full Hierarchial Clustering in figure \@ref(fig:dendPlots) (RIGHT) is the full model with all the variable and the Reduced Variable clustering in figure 5.2 (lEFT) only hasthe variables rating, genre, year, score, and budget. The Reduced Variable Hierarchial Clustering ended up with 6 clades, while the Full Clustering had 3. 
