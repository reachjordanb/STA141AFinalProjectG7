...
The most interesting finding in the Full Hierarchial Clustering was the red cluster, which had a different clade than the green and blue. The Reduced Variable Hierarchial Clustering ended up with 6 clusters, while the Full Clustering had 3.
...
The variables that both clusters share (rating, genre, year, score, and budget) had the same overall mean and proportion.
